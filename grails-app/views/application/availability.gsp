...
<div id="page-content-wrapper">
    <div id="createScheduleWrapper">
        ...
        <div class='row'  >
            <div class='col-xs-12'>
                <div class='panel well' style='min-width:700px; padding:0px'>
                    <div class='panel-heading row' style="margin:0px">
                        <div class="col-xs-7" style="font-size:22px; padding-left:0px">
                            Availability
                        </div>
                    ...
                    <div class='panel-body createSchedulePanelBody'>
                        ...
                        <div class='row createScheduleButtonRow'>
                            <div class='col-xs-5 '>
                                ...
                                <g:elseif test="${pageName=="Availability"}">
                                    <div class="btn-group" role="group" aria-label="...">
                                        <div class="btn-group" id="" >
                                            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="" aria-expanded="false">
                                                <span class="glyphicon glyphicon-pencil"> </span>
                                                <span id="">Unavailable</span><div id="" style="background-color: #AF2121; height:15px; width:15px; float:right; margin-top:3px; margin-left:10px"></div>
                                            </button>
                                        </div>
                                    </div>
                ...
                <form class="form-horizontal">
                    <div class="form-group" id="shiftTypesDropdownModal">
                        ...
                        <div class ="col-sm-10">
                            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="" aria-expanded="false">
                                <span class="glyphicon glyphicon-pencil"> </span>
                                <span id="shiftUnavailableTypeDropdownTextModal">Unavailable</span><div id="shiftUnavailableTypeDropDownColorBoxModal" style="background-color: #AF2121; height:15px; width:15px; float:right; margin-top:3px; margin-left:10px"></div>
                            </button>
                            <ul class="dropdown-menu" role="menu">
                    ...
                    <div class="form-group" id="repeatSelectorGroup" style="display:">
                    ...
                    <div class="form-group" id="repeatEndSelectorGroup" style="display:none">
                        ...
                        <div class ="col-sm-3">
                            <select class="form-control" id="repeatEndSelector" style="width: 120px">
                                <g:each var="c" in="${["Never", "1 Year", "After", "On Date"]}">
                                    <option value="${c}">${c}</option>
                                </g:each>
                            </select>
                        </div>
...
<div class="modal fade" id="weeklyShiftModal" tabindex="-1" role="dialog" aria-labelledby="weeklyShiftModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="weeklyShiftModalLabel">Repeating Event</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal">
